$(function() {
  $('#sendForm').on('click', 'button', function(e) {
    ...
    var msg = "https://wa.me/?text=*UPDATE%20-%20Pátio%20de%20Madeiras*%0A" + dataformatada + "%20-%20" + horaTurno + "%0A%0A*Produção atual:*%20" + producao + "%20tn%0A%0A*Última%20troca%20de%20facas*%0A" + encodeURIComponent("✅") + "%20*PT-01:*%20" + pt01 + "%20hrs%0A"+ encodeURIComponent("✅") + "%20*PT-02:*%20" + pt02 + "%20hrs%0A%0A*Paradas%20do%20processo*%0A" + encodeURIComponent("✔️") +  "%20DDS:%20" + dds + "%20min%0A" + encodeURIComponent("✔️") +  "%20Entupimentos:%20" + entupimentos + "%20min%0A" + encodeURIComponent("✔️") +  "%20Enroscos:%20" + enroscos + "%20min%0A" + encodeURIComponent("✔️") +  "%20Falta de energia:%20" + energia + "%20min%0A" + encodeURIComponent("✔️") +  "%20Mecânica:%20" + mecanica + "%20min%0A" + encodeURIComponent("✔️") +  "%20Lubrificação:%20" + lubrificacao + "%20min%0A" + encodeURIComponent("✔️") +  "%20Outros:%20" + outros + "%20min%0A" + encodeURIComponent("⏰") +  "%20Intertravamento Descascador:%20" + intertravamento + "%20min%0A%0A" + encodeURIComponent("✅") + "%20*Obervação:*%0A" + observacao + "%0A%0A" + encodeURIComponent("✅") + "%20*Afiado:*%20" + afiado + "%20jogos%20de%20facas%0A%0A" + encodeURIComponent("✅") + "%20*Transbordo:*%20" + transbordo + "%20viagens%0A%0A" + encodeURIComponent("✅") + "%20*Pendências:*%0A" + pendencias;
